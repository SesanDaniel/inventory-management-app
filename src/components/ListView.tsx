          ...
          filteredAndSortedRows.map((row, index) => {
            ...
            return (
              <div
                ...
                className="animate-fade-slide-up group relative bg-white/5 backdrop-blur-md hover:bg-white/10 hover:scale-[1.01] active:scale-[0.98] border border-white/10 hover:border-white/20 rounded-2xl p-4 flex items-center justify-between cursor-pointer transition-all duration-300 shadow-xl"
              >
