...
export default function MobileFrame({ children }: MobileFrameProps) {
  ...
  <div className="relative w-full sm:max-w-[420px] h-screen sm:h-[840px] bg-slate-950 sm:rounded-[48px] shadow-none sm:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] border-0 sm:border-[10px] border-slate-800 flex flex-col overflow-hidden transition-all duration-300">
        ...
        {/* Status Bar */}
        <div className="h-12 bg-slate-900 px-6 pt-3 flex items-center justify-between text-slate-300 text-xs font-semibold select-none z-40 border-b border-slate-800/40">
        ...
        {/* Content Window with inner glowing mesh background */}
        ...
        <div className="h-5 bg-slate-900 flex items-center justify-center select-none z-40 border-t border-slate-800/40">
